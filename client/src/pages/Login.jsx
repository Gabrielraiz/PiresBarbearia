      ...
      <div className="w-full max-w-md relative z-10 animate-in fade-in zoom-in-95 duration-1000">
        <div className="text-center mb-10">
          ...
          <h1 className="font-display font-black text-4xl text-[var(--text-primary)] tracking-tighter uppercase italic leading-none mb-3">
            {settings.site_name || 'PIRESQK'} <span className="text-[var(--gold)]">CLUB</span>
          </h1>
        ...
        <div className="card p-8 md:p-10 bg-[var(--bg-card)]/40 backdrop-blur-3xl border border-[var(--border)] shadow-2xl rounded-[2.5rem]">
          {error && (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label className="flex items-center gap-2 text-[var(--text-secondary)] text-[10px] font-black tracking-[0.3em] uppercase italic ml-1">
                <Icons.Mail size={12} className="text-[var(--gold)]" /> E-MAIL
              </label>
          ...
          <div className="mt-8 pt-8 border-t border-[var(--border)] text-center">
            <p className="text-[var(--text-secondary)] text-[10px] font-black tracking-widest uppercase mb-4">
              {lang ? "NEW TO THE CLUB?" : 'AINDA NÃO É MEMBRO?'}
            </p>
            <Link 
              to="/register" 
            ...
            >
              {lang ? 'CREATE ACCOUNT' : 'CRIAR MINHA CONTA'}
              <Icons.UserPlus size={14} className="group-hover:scale-110 transition-transform" />
            </Link>
          </div>
        </div>
