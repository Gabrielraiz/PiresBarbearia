...
const Icons = {
  ...
  Star: ({ size = 20, className = '', filled = false, fill }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={fill ?? (filled ? 'currentColor' : 'none')} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
  ...
  Settings: ({ size = 20, className = '' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <circle cx="12" cy="12" r="3"/><path d="M19.07 4.93a10 10 0 0 1 1.94 2.13l-1.7 1.39a8 8 0 0 0-1.54-1.69zM12 2a10 10 0 0 1 2.44.3l-.47 2a8 8 0 0 0-1.97-.3zM4.93 4.93l1.39 1.7A8 8 0 0 0 4.63 8.3l-1.94-.56A10 10 0 0 1 4.93 4.93zM2.3 9.56l2 .47A8 8 0 0 0 4 12a8 8 0 0 0 .3 1.97l-2 .47A10 10 0 0 1 2 12c0-.83.1-1.63.3-2.44zM4.93 19.07A10 10 0 0 1 2.76 16.94l1.94-.56a8 8 0 0 0 1.54 1.69zM12 22a10 10 0 0 1-2.44-.3l.47-2a8 8 0 0 0 1.97.3 8 8 0 0 0 1.97-.3l.47 2A10 10 0 0 1 12 22zM19.07 19.07l-1.39-1.7a8 8 0 0 0 1.69-1.54l1.94.56a10 10 0 0 1-2.24 2.68zM21.7 14.44l-2-.47A8 8 0 0 0 20 12a8 8 0 0 0-.3-1.97l2-.47C21.9 10.37 22 11.17 22 12c0 .83-.1 1.63-.3 2.44z"/>
    </svg>
  ),
  ...
  Palette: ({ size = 20, className = '' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.476-1.125-.29-.289-.284-.752.026-1.035C14.31 17.045 15 15.76 15 14.5c0-2.209-1.35-3.75-3-3.75"/>
    </svg>
  ),
  ...
  Handshake: ({ size = 20, className = '' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="m11 17 2 2 6-6"/><path d="m18 14 2.5 2.5a3.3 3.5 0 0 1-5 5l-8.5-8.5a2.5 2.5 0 0 1 3.5-3.5L12 11"/><path d="M7 17H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v1.5"/><path d="M13 19H7"/>
    </svg>
  ),
